    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/**").hasAnyRole("admin", "careworker")
                        .requestMatchers(HttpMethod.PUT, "/api/**").hasAnyRole("admin", "careworker")
                        .requestMatchers(HttpMethod.DELETE, "/api/**").hasAnyRole("admin", "careworker")
